...
@section('content')
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10 text-center">
                        ...
                        <h1 class="page-header-title">Welcome to Programming Blog</h1>
                        ...
                        <form class="page-header-signup mb-2 mb-md-0" method="get" action="#">
                            <div class="form-row justify-content-center">
                                <div class="col-lg-6 col-md-8">
                                    <div class="form-group mr-0 mr-lg-2"><input class="form-control form-control-solid rounded-pill" type="text" name="search" value="{{request('search')}}" placeholder="Search keyword..."/></div>
                                </div>
    ...
    @if($posts->count())
@include('comp.post-featuerd ', ['post'=>$posts[0]])
